                ...
                <li>
                    @if($l->image_url)
                        <div class="ling-img-box">
                            <a href="{{ $category }}/article/{{ $l->id }}" class="thumbnail">
                                <img src="{{ asset('img/blank.gif') }}" data-echo="{{ env('img_src_pre','').$l->image_url }}">
                            </a>
                        </div>
                    @endif
                    <div class="ling-txt-box">
                        <h3 style="font-size: 22px;line-height: 30px; margin: 0; padding: 0;"><a href="article/{{ $l->id }}">{{ filterTitle($l->id,$l->title) }}</a></h3>
